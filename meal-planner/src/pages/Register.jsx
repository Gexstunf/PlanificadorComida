    ...
    return (
      <div className="auth-page">
        <div className="auth-card auth-card--success">
          <span className="auth-card__icon">OK</span>
          <h2>Cuenta creada</h2>
    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-card__header">
          <span className="auth-card__icon">MP</span>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="auth-form__field">
            ...
            <input id="password" type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Mínimo 6 caracteres" required autoComplete="new-password" />
          </div>

          <div className="auth-form__field">
            <label htmlFor="confirm">Confirmar contraseña</label>
            <input id="confirm" type="password" value={confirm} onChange={e => setConfirm(e.target.value)} placeholder="Repetí la contraseña" required autoComplete="new-password" />
          </div>
